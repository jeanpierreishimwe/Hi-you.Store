...
<!------------------ new top related Second list End here--------------->
        ...
        ?>
          ...
          <div class="store-product-main">
            ...
            <h2 class="store-title">other Products</h2>
...
<!--Fetch all products End here-->
          ...
          <!--<div class="store-product-main">
            ...
            <h2 class="store-title">Products Details</h2>
  ...
  <div class="store-container">
    ...
    <ul class="store-footer-nav-list">
      ...
      <li class="store-footer-nav-item flex">
        ...
        <a href="mailto:example@gmail.com" class="store-footer-nav-link">Catcherwe@gmail.com</a>
      </li>
